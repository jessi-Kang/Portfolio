  ...
  return (
    ...
    >
        ...
        <>
          ...
          <div className={`grid gap-3 ${
            ...
            {project.highlights.map((h, i) => (
              <div key={i} className="bg-gray-800/60 rounded-xl p-3.5 text-center">
      ...
      {hasInsight && (
        <>
          <Divider />
          <div className="flex gap-3 items-start bg-accent/5 border border-accent/10 rounded-xl px-4 py-3.5">
        ...
        <>
          ...
          <div className="flex flex-wrap gap-2">
            {project.metrics.map((m, i) => (
              <span key={i} className="inline-flex items-center text-xs px-3 py-1.5 bg-gray-800 text-gray-400 rounded-full">
                {m}
              </span>
            ))}
          </div>
